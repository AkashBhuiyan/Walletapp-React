...
class CreateWallet extends Component {
    ...
    /*if the props value will change from response then the life
    cycle automatically update the state to nextProps changes*/
...
/*Connect method to the redux store. first parameter is for data  and second parameter is for actions*/
